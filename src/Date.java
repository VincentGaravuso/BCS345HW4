...
public class Date
{
   ...
   /*
   Creates a new date with default values for year, month and day (2001, 1, 1 respectively).
   */
   public Date()
   {
       this.year = 2001;
   ...
   */
   ...
   /*
   Sets a dates year, month and day respectively.
   Year must be between 1900 and 2019
   Month must be between values 1 and 12
   Day must be between 1 and 31 depending on the month.
   Defaults year, month and day to 2001, 1, 1 respectively.
   */
